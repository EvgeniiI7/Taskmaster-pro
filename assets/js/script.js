...
// The function saveTAsks simply saves the tasks object in localStorage, as we can see here:
...
// Convert Trash into a Droppable. Currently, the only way to delete a task is to delete all tasks at once. 
